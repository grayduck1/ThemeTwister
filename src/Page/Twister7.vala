    ...
    public class Twister7 : Gtk.Box {
        public Twister7 () {
			...
			button.clicked.connect (() => {
		        try {
		        	GLib.AppInfo info = AppInfo.create_from_commandline("xfce4-terminal --title=Config --hide-menubar --hide-borders --hide-scrollbar -e \"/usr/share/ThemeSwitcher/ThemeTwister Raspbian7\"", null, AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION);
