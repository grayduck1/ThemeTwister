    ...
    public class iTwisterSur : Gtk.Box {
        public iTwisterSur () {
			...
			button.clicked.connect (() => {
		        try {
		        	GLib.AppInfo info = AppInfo.create_from_commandline("xfce4-terminal --title=Config --hide-menubar --hide-borders --hide-scrollbar -e \"/usr/share/ThemeSwitcher iRaspbianSur\"", null, AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION);
